...
1. 릴리즈 keystore를 분리하고 Export preset에 연결합니다.
2. 대표 스테이지(Stage 1, 11, 25, 50, 75, 100) 수동 QA 게이트를 통과시킵니다.
3. Android 실기기에서 햅틱 동작을 검증합니다.
4. 후반 밴드 장애물 확장을 다음 스프린트 1순위로 준비합니다.
5. 31~100 밸런스 패스와 클리어 별 팝 애니메이션을 다음 라운드에 포함합니다.
