...
validate_template_contract() {
	...
	require_template_text "android export config preflight" "| Android export config |"
	require_template_text "android export config command" "zsh scripts/validate_android_export_config.sh"
	require_template_text "android export package id" "com.shinehandmac.zoozoopop"
	require_template_text "android release export preflight" "| Android release APK export/install |"
	require_template_text "android release export command" "zsh scripts/export_android_release.sh --install"
	require_template_text "android release export evidence" "android-release-export.txt"
	require_template_text "android release install evidence" "release-install-log.txt"
	require_template_text "android release run evidence" "release-run-log.txt"
	require_template_text "release keystore path env" "GODOT_ANDROID_KEYSTORE_RELEASE_PATH"
	require_template_text "release keystore user env" "GODOT_ANDROID_KEYSTORE_RELEASE_USER"
	require_template_text "release keystore password env" "GODOT_ANDROID_KEYSTORE_RELEASE_PASSWORD"
