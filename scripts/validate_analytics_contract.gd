...
const REQUIRED_EVENTS := {
	...
	"animal_token_gain": ["session_id", "animal_id", "amount", "source", "stage_id", "token_balance"],
	"animal_friendship_level_up": ["session_id", "animal_id", "level_before", "level_after", "reward_id"],
	"animal_cosmetic_equip": ["session_id", "animal_id", "cosmetic_id", "cosmetic_type", "entry_point", "source", "friendship_level", "token_balance"],
