...
- `zsh scripts/validate_render_snapshots.sh`는 Home, Stage Popup, Stage 4 Gameplay HUD, Stage 1 성공 결과 overlay, Stage 25 실패 overlay, Stage 31 특수 조합 6종, Collection을 `390x844`와 `844x390` PNG 24장으로 저장한다.
