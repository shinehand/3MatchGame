...
- Stage 5 `soft_bomb_plus`, Stage 8 `combo_peep`, Stage 18 `leap_clear`, Stage 31 `cascade_slide`, Stage 81 `mighty_push`는 scene smoke에서 실제 상태 변화와 `buddy_skill_trigger`를 검증한다.
