...
- Meta modal/card readability gate: Collection portrait가 2열 앨범 카드로 읽히고 landscape 첫 카드가 얇은 row로 무너지지 않는지, 동물 preview가 충분히 큰지, Stage Popup landscape panel과 `PLAY` CTA가 상용 start modal 위계를 유지하는지 확인
