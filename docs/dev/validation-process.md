...
- Result overlay density gate: Stage 1 성공 overlay와 Stage 25 near-miss 실패 overlay의 본문 visible line을 6개 이하로 유지하고, 보상/토큰/Zoo-Zoo Time 또는 실패 목표/핵심/다음 한 수를 `OverlayChipGrid` 칩으로 분리해 상용 카드 판독성을 확인
